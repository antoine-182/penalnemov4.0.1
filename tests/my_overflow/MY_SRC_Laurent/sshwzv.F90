...
CONTAINS
   ...
   SUBROUTINE ssh_nxt( kt )
      ...
      !
!!an ssh should results in the elevation of the column
...
!                  ENDIF
                  ...
                  !même sur la dynamique on avait du bruit -> le calcul du cfl n'est pas adapté
                  ! zcff = 1._wp
                  !!an
