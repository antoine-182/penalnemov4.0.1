MODULE usrdef_sbc
   ...
   !!----------------------------------------------------------------------
   !!   usr_def_sbc    : user defined surface bounday conditions in SLOPE case
   !!----------------------------------------------------------------------
...
CONTAINS
   ...
   SUBROUTINE usrdef_sbc_oce( kt )
      ...
      !!
      !! ** Method  :   all 0 fields, for SLOPE case
      ...
      IF( kt == nit000 ) THEN
         !
         IF(lwp) WRITE(numout,*)' usr_sbc : SLOPE case: NO surface forcing'
