MODULE usrdef_hgr
   ...
   !!----------------------------------------------------------------------
   !!   usr_def_hgr    : initialize the horizontal mesh for SLOPE configuration
   !!----------------------------------------------------------------------
...
CONTAINS
   ...
   SUBROUTINE usr_def_hgr( plamt , plamu , plamv  , plamf  ,   &   ! geographic position (required)
      ...
      !!                SLOPE configuration : uniform grid spacing (rn_dx)
      ...
      !
      IF(lwp) WRITE(numout,*)
      IF(lwp) WRITE(numout,*) 'usr_def_hgr : SLOPE configuration bassin'
