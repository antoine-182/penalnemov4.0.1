...
CONTAINS
   ...
   SUBROUTINE dyn_nxt ( kt )
      ...
      IF ( ln_dynspg_ts ) THEN
         ...
         END DO
!!an ua_b a ete calcule par dynspg_ts, on remplace la partie barotrope de ua (integre avec dynzdf)
!!   par la composante barotrope calcule par dynspg_ts (on corrige)
!!   de l'importance de bien inclure les friction de fond (ect) dans le couplage barotrope
!!key_barocline -> ua_b reste a 0 et la boucle suivante retire la partie barotrope du flow
         DO jk = 1, jpkm1
